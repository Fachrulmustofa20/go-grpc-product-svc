...
var file_pkg_pb_product_proto_rawDesc = []byte{
	...
	0x69, 0x64, 0x22, 0x69, 0x0a, 0x0f, 0x46, 0x69, 0x6e, 0x64, 0x4f, 0x6e, 0x65, 0x52, 0x65, 0x73,
	...
	0x4f, 0x6e, 0x65, 0x44, 0x61, 0x74, 0x61, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x22, 0x6f, 0x0a,
	...
	0x65, 0x18, 0x05, 0x20, 0x01, 0x28, 0x03, 0x52, 0x05, 0x70, 0x72, 0x69, 0x63, 0x65, 0x22, 0x40,
...
var file_pkg_pb_product_proto_goTypes = []interface{}{
	...
	(*FindOneRequest)(nil),        // 2: product.FindOneRequest
	(*FindOneResponse)(nil),       // 3: product.FindOneResponse
	(*FindOneData)(nil),           // 4: product.FindOneData
...
var file_pkg_pb_product_proto_depIdxs = []int32{
	4, // 0: product.FindOneResponse.data:type_name -> product.FindOneData
	0, // 1: product.ProductService.CreateProduct:input_type -> product.CreateProductRequest
	2, // 2: product.ProductService.FindOne:input_type -> product.FindOneRequest
	...
	3, // 5: product.ProductService.FindOne:output_type -> product.FindOneResponse
